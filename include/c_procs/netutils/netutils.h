...
/* Set SO_REUSEADDR for listen socket, also can set SO_REUSEPORT if defined */
...
/* try recv until end char on the end readed bytes, max_len reached or error returned */
